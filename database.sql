...
INSERT INTO `lokasi` (`id_lokasi`, `nama_kota`, `tanggal_input`) VALUES
(6, 'A1', '2017-05-23'),
(7, 'A2', '2017-05-24'),
(8, 'A3', '2017-05-24');
...
--
-- Table structure for table `nilai_lokasi`
--

CREATE TABLE `nilai_lokasi` (
  `id_nilai_lokasi` int(11) NOT NULL,
  `id_lokasi` int(10) NOT NULL,
  `id_kriteria` int(10) NOT NULL,
...
--
-- Dumping data for table `nilai_lokasi`
--

INSERT INTO `nilai_lokasi` (`id_nilai_lokasi`, `id_lokasi`, `id_kriteria`, `nilai`) VALUES
(25, 8, 11, 1),
(26, 8, 12, 0.5),
(27, 8, 13, 0.5),
(28, 8, 14, 0.75),
...
--
-- Indexes for table `nilai_lokasi`
--
ALTER TABLE `nilai_lokasi`
  ADD PRIMARY KEY (`id_nilai_lokasi`),
  ADD UNIQUE KEY `id_lokasi_2` (`id_lokasi`,`id_kriteria`),
...
--
-- AUTO_INCREMENT for table `nilai_lokasi`
--
ALTER TABLE `nilai_lokasi`
  MODIFY `id_nilai_lokasi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
...
--
-- Constraints for table `nilai_lokasi`
--
ALTER TABLE `nilai_lokasi`
  ADD CONSTRAINT `nilai_lokasi_ibfk_1` FOREIGN KEY (`id_lokasi`) REFERENCES `lokasi` (`id_lokasi`),
  ADD CONSTRAINT `nilai_lokasi_ibfk_2` FOREIGN KEY (`id_kriteria`) REFERENCES `kriteria` (`id_kriteria`);
