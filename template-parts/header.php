...
<body>
	...
	<header id="header">
		<div class="container clearfix">
			<div id="logo-wrap">
				<h1 id="logo"><a href="index.php"><img src="images/logo4.png" alt=""></a></h1>
			</div>
				...
				<nav id="nav">
					<ul class="sf-menu">
						...
						<?php if($user_role == 'admin' || $user_role == 'petugas'): ?>
							<li><a href="list-lokasi.php">Lokasi</a>
								<ul>
									<li><a href="list-lokasi.php">List Lokasi</a></li>
									<li><a href="tambah-lokasi.php">Tambah Lokasi</a></li>
								</ul>
							</li>
						<?php endif; ?>
